...
import (
	...
	mcptools "exact-online-accountancy-pp-cli/internal/mcp"
...
func main() {
	...
	_ = os.Setenv("EXACT_ONLINE_ACCOUNTANCY_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "exact-online-accountancy-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
