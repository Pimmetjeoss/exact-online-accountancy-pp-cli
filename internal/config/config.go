...
type Config struct {
	...
	ExactOnlineAccountancyOauth2 string          `toml:"online_accountancy_oauth2"`
}
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("EXACT_ONLINE_ACCOUNTANCY_OAUTH2"); v != "" {
		cfg.ExactOnlineAccountancyOauth2 = v
		cfg.markEnvOverride("ExactOnlineAccountancyOauth2")
		cfg.AuthSource = "env:EXACT_ONLINE_ACCOUNTANCY_OAUTH2"
		cfg.CredentialSource = "env:EXACT_ONLINE_ACCOUNTANCY_OAUTH2"
	}
	...
	if v := os.Getenv("EXACT_ONLINE_ACCOUNTANCY_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	if v := os.Getenv("EXACT_ONLINE_ACCOUNTANCY_AUTHORIZATION_URL"); v != "" {
		cfg.AuthorizationURL = v
	}
	if v := os.Getenv("EXACT_ONLINE_ACCOUNTANCY_TOKEN_URL"); v != "" {
		cfg.TokenURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("EXACT_ONLINE_ACCOUNTANCY_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "exact-online-accountancy-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	// A directly-held bearer in EXACT_ONLINE_ACCOUNTANCY_OAUTH2 (a pasted access token, or a
	...
	if c.ExactOnlineAccountancyOauth2 != "" {
		return "Bearer " + c.ExactOnlineAccountancyOauth2
	}
	return ""
}
...
func (c *Config) StoreScopeCredential() string {
	...
	if c.ExactOnlineAccountancyOauth2 != "" {
		parts = append(parts, "online_accountancy_oauth2="+c.ExactOnlineAccountancyOauth2)
	}
	if len(parts) == 0 {
		return ""
	}
...
func (c *Config) clearCredentialFields() {
	...
	c.ClientID = ""
	c.ClientSecret = ""
	c.ExactOnlineAccountancyOauth2 = ""
}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		ExactOnlineAccountancyOauth2: c.ExactOnlineAccountancyOauth2,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	if c.ExactOnlineAccountancyOauth2 == "" {
		c.ExactOnlineAccountancyOauth2 = creds.ExactOnlineAccountancyOauth2
	}
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.ExactOnlineAccountancyOauth2 = ""
	delete(c.envOverrides, "ExactOnlineAccountancyOauth2")
	c.updateFileConfigField("ExactOnlineAccountancyOauth2")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["ExactOnlineAccountancyOauth2"] {
			out.ExactOnlineAccountancyOauth2 = c.fileConfig.ExactOnlineAccountancyOauth2
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "ExactOnlineAccountancyOauth2":
		c.fileConfig.ExactOnlineAccountancyOauth2 = c.ExactOnlineAccountancyOauth2
	}
}
