...
const (
	journalSessionEnvVar   = "EXACT_ONLINE_ACCOUNTANCY_LEARN_SESSION"
	journalNoLearnEnvVar   = "EXACT_ONLINE_ACCOUNTANCY_NO_LEARN"
	journalNoCaptureEnvVar = "EXACT_ONLINE_ACCOUNTANCY_LEARN_NO_CAPTURE"
)
