...
var clearedVars = []string{
	"EXACT_ONLINE_ACCOUNTANCY_CONFIG",
	"EXACT_ONLINE_ACCOUNTANCY_CONFIG_DIR",
	"EXACT_ONLINE_ACCOUNTANCY_DATA_DIR",
	"EXACT_ONLINE_ACCOUNTANCY_STATE_DIR",
	"EXACT_ONLINE_ACCOUNTANCY_CACHE_DIR",
	"EXACT_ONLINE_ACCOUNTANCY_HOME",
	"XDG_CONFIG_HOME",
	"XDG_DATA_HOME",
	"XDG_STATE_HOME",
	"XDG_CACHE_HOME",
