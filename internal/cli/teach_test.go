...
import (
	...
	"exact-online-accountancy-pp-cli/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"exact-online-accountancy-pp-cli auth login",
		"exact-online-accountancy-pp-cli doctor",
		"exact-online-accountancy-pp-cli help items",
		"exact-online-accountancy-pp-cli sync",
		"exact-online-accountancy-pp-cli profile list",
		"exact-online-accountancy-pp-cli feedback list",
		"exact-online-accountancy-pp-cli which",
		"exact-online-accountancy-pp-cli agent-context",
		"exact-online-accountancy-pp-cli completion bash",
		"exact-online-accountancy-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"exact-online-accountancy-pp-cli recall",
		"exact-online-accountancy-pp-cli learnings",
		"exact-online-accountancy-pp-cli teach-pattern",
		"exact-online-accountancy-pp-cli teach-lookup",
		"exact-online-accountancy-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		dbPath := defaultDBPath("exact-online-accountancy-pp-cli")
