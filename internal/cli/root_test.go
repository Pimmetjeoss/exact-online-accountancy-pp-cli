...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"accountancy",
		"accountancy account-involved-accounts-delete",
		"accountancy account-involved-accounts-get",
		"accountancy account-involved-accounts-post",
		"accountancy account-involved-accounts-put",
		"accountancy account-owners-delete",
		"accountancy account-owners-get",
		"accountancy account-owners-post",
		"accountancy account-owners-put",
		"accountancy client-groups-get",
		"accountancy client-main-groups-get",
		"accountancy involved-user-roles-delete",
		"accountancy involved-user-roles-get",
		"accountancy involved-user-roles-post",
		"accountancy involved-user-roles-put",
		"accountancy involved-users-delete",
		"accountancy involved-users-get",
		"accountancy involved-users-post",
		"accountancy involved-users-put",
		"accountancy solution-links-delete",
		"accountancy solution-links-get",
		"accountancy solution-links-post",
		"accountancy solution-links-put",
		"accountancy task-types-delete",
		"accountancy task-types-get",
		"accountancy task-types-post",
		"accountancy task-types-put",
	}
