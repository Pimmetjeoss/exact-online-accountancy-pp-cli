...
type rootFlags struct {
	...
	// invocation. Mirrors the EXACT_ONLINE_ACCOUNTANCY_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "exact-online-accountancy-pp-cli",
		Short: "Manage exact-online-accountancy resources via the exact-online-accountancy API",
		Long: `Manage exact-online-accountancy resources via the exact-online-accountancy API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'exact-online-accountancy-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("exact-online-accountancy-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.runProfileName, "profile", "", "Apply values from a saved run profile; this does not select a client (see 'exact-online-accountancy-pp-cli profile list')")
	...
	rootCmd.AddCommand(newAccountancyCmd(flags))
